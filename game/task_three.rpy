...
label task_three_bond:
    ...
    pov "You've got to help! Just look at it, what a mess! You gather what supplies you can and set to work..."
    
    menu:
        "Let's start with the wheels. They sounded bad.":
            show robovac sad
        ...
        "Let's empty your tank. You're probably full by now.":
            show robovac scared
        ...
        "You could use a wash-you're covered in dust!":
    ...
    pov "Alright, my hardworking little menace, what's next?"
...
label task_three_threaten:
    ...
    menu:
        ...
        "Option Threaten 1 - Your wheels must be tangled. Let's deal with that.":
            show robovac scared
        ...
        "Option Threaten 2 - I hope your tank didn't fill up that quickly, but I'll check anyway.":
            show robovac sad
            ...
            # Audio - [Beeps anxiously]

            robovac "..."

        "Option Threaten 3 - You're filthy. Probably tracking around as much dirt as you're sucking up.":
    ...
    pov "Alright, let's get this over with. What next?"
...
label task_three_neglect:
    ...
    menu:
        "I need dinner. Let's see what's in the fridge.":
        ...
        "I've been meaning to finish a couple games...I should get on those.":
        ...
        " I really ought to treat myself to a nice bath or something, it's been awhile.":
